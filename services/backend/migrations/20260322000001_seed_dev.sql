...
SELECT v.price, v.addr, v.use_type, v.yr, ST_SetSRID(ST_MakePoint(v.lng, v.lat), 4326)
FROM (VALUES
  -- 丸の内 (Marunouchi) — prime commercial
  (5200000, '千代田区丸の内1-9-1',  '商業', 2024, 139.76714, 35.68123),
  (5000000, '千代田区丸の内1-9-1',  '商業', 2023, 139.76714, 35.68123),
  (4800000, '千代田区丸の内1-9-1',  '商業', 2022, 139.76714, 35.68123),
  (4500000, '千代田区丸の内1-9-1',  '商業', 2021, 139.76714, 35.68123),
  (4600000, '千代田区丸の内1-9-1',  '商業', 2020, 139.76714, 35.68123),
  -- 銀座 (Ginza) — high-end commercial
  (4100000, '中央区銀座4-5-6',      '商業', 2024, 139.76493, 35.67170),
  (3900000, '中央区銀座4-5-6',      '商業', 2023, 139.76493, 35.67170),
  (3700000, '中央区銀座4-5-6',      '商業', 2022, 139.76493, 35.67170),
  (3500000, '中央区銀座4-5-6',      '商業', 2021, 139.76493, 35.67170),
  (3600000, '中央区銀座4-5-6',      '商業', 2020, 139.76493, 35.67170),
  -- 神田 (Kanda) — mixed residential/commercial
  (1200000, '千代田区神田須田町1-2', '住居', 2024, 139.77120, 35.69410),
  (1150000, '千代田区神田須田町1-2', '住居', 2023, 139.77120, 35.69410),
  (1100000, '千代田区神田須田町1-2', '住居', 2022, 139.77120, 35.69410),
  (1050000, '千代田区神田須田町1-2', '住居', 2021, 139.77120, 35.69410),
  (1000000, '千代田区神田須田町1-2', '住居', 2020, 139.77120, 35.69410)
) AS v(price, addr, use_type, yr, lng, lat)
