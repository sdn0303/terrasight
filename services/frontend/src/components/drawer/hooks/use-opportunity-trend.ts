...
/**
 * Fetches the price trend series for a specific lat/lng coordinate.
 * Wraps the shared trend query key for cache sharing with other consumers.
 */
export function useOpportunityTrend(
  lat: number | null,
  lng: number | null,
  years?: number,
) {
