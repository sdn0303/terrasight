...
const PREFECTURE_BBOXES: readonly PrefBBox[] = [
  ...
  { code: "02", south: 40.22, west: 139.50, north: 41.56, east: 141.68 },
  { code: "03", south: 38.75, west: 139.69, north: 40.45, east: 141.68 },
  { code: "04", south: 37.77, west: 140.27, north: 39.00, east: 141.68 },
  { code: "05", south: 39.00, west: 139.70, north: 40.51, east: 140.96 },
  ...
  { code: "09", south: 36.20, west: 139.33, north: 37.15, east: 140.29 },
  { code: "10", south: 36.06, west: 138.64, north: 37.06, east: 139.68 },
  { code: "11", south: 35.77, west: 138.91, north: 36.28, east: 139.91 },
  { code: "12", south: 34.90, west: 139.77, north: 36.11, east: 140.87 },
  { code: "13", south: 35.50, west: 138.94, north: 35.90, east: 139.92 },
  { code: "14", south: 35.13, west: 138.91, north: 35.67, east: 139.78 },
  { code: "15", south: 37.00, west: 137.86, north: 38.55, east: 140.02 },
  ...
  { code: "24", south: 33.73, west: 135.85, north: 35.25, east: 137.00 },
  ...
  { code: "32", south: 34.30, west: 131.66, north: 36.35, east: 133.38 },
  ...
  { code: "38", south: 32.90, west: 132.01, north: 34.10, east: 133.69 },
  { code: "39", south: 32.71, west: 132.48, north: 33.88, east: 134.31 },
  { code: "40", south: 33.00, west: 130.02, north: 33.96, east: 131.19 },
  { code: "41", south: 32.97, west: 129.74, north: 33.60, east: 130.57 },
  { code: "42", south: 32.57, west: 128.61, north: 34.70, east: 130.34 },
  { code: "43", south: 32.07, west: 130.03, north: 33.19, east: 131.30 },
