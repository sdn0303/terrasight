...
export const DATA_MODES: readonly DataModeConfig[] = [
  ...
  { id: "land-price", label: "Land Price", labelJa: "基準地価", available: true },
  ...
  { id: "transactions", label: "Transactions", labelJa: "取引事例", available: true },
  { id: "hazard", label: "Hazard Map", labelJa: "ハザードマップ", available: true },
] as const;
